...
import {Banner, TextWrapper, MoreText, SectionTwo,
       SectionThree, FlexBoxIndex, GenereicPara, GenericH2, SectionFour, FormFive} from "../styles/IndexStyles";
...
export default () => (
  ...
  <div style={{position: 'relative'}}>
    ...
    <TextWrapper>
      <div>
        <GenericH2>GoodHacker</GenericH2>
  ...
  <SectionTwo>
    <div>
      ...
      <GenereicPara>Most good programmers do programming not because they expect to get paid, but because it's fun to program.</GenereicPara>
