...
&:after {
    ...
    background-attachment: ${props => (props.parallax ? "80vh" : "100vh")};
...
font-size: ${props => (props.no ? "6rem" : "3rem")};
padding: ${props => (props.no ? "0" : "0.3em 0")};
color: ${props => (props.dark ? "#656665" : "#ffffff")};
border-bottom: ${props => (props.no ? "0" : "2px solid #1d9c91")};
text-transform: uppercase;
letter-spacing: 0.6rem;
margin: 0;
padding-bottom: ${props => (props.no ? "0.3em" : "0.3em")};
...
export {Banner, TextWrapper, MoreText, SectionTwo, SectionThree, 
    GenereicPara, GenericH2, FlexBoxIndex, SectionFour, FormFive,Footer, Header, Works, GenericH3, GenereicParaAbout};